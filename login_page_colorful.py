...
class LoginPage(QWidget):
    def __init__(self, users, switch_to_profile_callback):
        ...
        # Set background color and apply styling
        self.setStyleSheet("""
        ...
        self.username_label.setStyleSheet("font-size: 14px; color: #555;")
        self.password_label.setStyleSheet("font-size: 14px; color: #555;")
        self.username_input.setStyleSheet("padding: 8px; font-size: 14px; border-radius: 5px;")
        self.password_input.setStyleSheet("padding: 8px; font-size: 14px; border-radius: 5px;")
        ...
        self.login_button.setStyleSheet("""
            ...
            border-radius: 5px;
        """)
        self.admin_checkbox.setStyleSheet("font-size: 14px; color: #555;")
...
class ProfilePage(QWidget):
    def __init__(self):
        ...
        self.info_label.setStyleSheet("font-size: 20px; color: #333; font-weight: bold;")
        self.username_label.setStyleSheet("font-size: 16px; color: #555;")
        self.role_label.setStyleSheet("font-size: 16px; color: #555;")
